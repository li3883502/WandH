    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dlilis.video.Category')),
                ('tags', models.ManyToManyField(to='dlilis.video.Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dlilis.video.Video', verbose_name='视频')),
                ('patent_comtents', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dlilis.video.Comment')),
            ],
        ),
    ]
