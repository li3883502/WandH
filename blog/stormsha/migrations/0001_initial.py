# Generated by Django 3.0 on 2019-04-18 02:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(auto_now_add=True, verbose_name='提交时间')),
            ],
            options={
                'verbose_name': '公告',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, verbose_name='一级目录')),
                ('num', models.IntegerField(default=0, verbose_name='总数')),
                ('slug', models.SlugField(unique=True)),
                ('keyword', models.TextField(default='StormSha的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('description', models.TextField(default='StormSha,静觅,网络,IT,技术,博客,Python', help_text='用来作为SEO中keywords,长度参考SEO标准', max_length=240, verbose_name='关键字')),
            ],
            options={
                'verbose_name': '一级目录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='StormSha的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好', verbose_name='描述')),
            ],
            options={
                'verbose_name': '标签',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='二级目录')),
                ('slug', models.SlugField(unique=True)),
                ...
                ('bigcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stormsha.Bigcategory', verbose_name='一级目录')),
            ],
            options={
                'verbose_name': '二级目录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stormsha.Category', verbose_name='文章分类')),
                ('keywords', models.ManyToManyField(help_text='文章关键词，用来作为SEO中keywords，最好使用长尾词，3-4个足够', to='stormsha.Keyword', verbose_name='文章关键词')),
                ('tags', models.ManyToManyField(to='stormsha.Tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '文章',
