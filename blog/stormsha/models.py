...
class Bigcategory(models.Model):
    name = models.CharField(u'一级目录', max_length=40)
    num = models.IntegerField(u'总数', default=0)
    slug = models.SlugField(unique=True)
    keyword = models.TextField(u'描述', max_length=240, default=settings.SITE_DESCRIPTION, help_text=u'用来作为SEO中description,长度参考SEO标准')
    description = models.TextField(u'关键字', max_length=240, default=settings.SITE_KEYWORDS, help_text=u'用来作为SEO中keywords,长度参考SEO标准')
...
class Keyword(models.Model):
    name = models.CharField(u'文章关键词', max_length=20)
...
class Activate(models.Model):
    ...
    add_date = models.DateTimeField('提交时间',auto_now_add=True)
